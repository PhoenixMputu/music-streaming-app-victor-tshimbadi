      ...
      {(headerTitle === 'Browse') && (
        <div>
          ...
          <div className='browse-headers'>
            ...
            <p className={viewType === 'New Releases' ? 'active' : ''} onClick={() => { fetchNewReleases(token); updateViewType('New Releases'); updateHeaderTitle('Browse'); }}>Nouveaux</p>
            <p className={viewType === 'Featured' ? 'active' : ''} onClick={() => { fetchFeatured(token); updateViewType('Featured'); updateHeaderTitle('Browse'); }}>Populaires</p>
          </div>
        </div>
      )}
    </div>
